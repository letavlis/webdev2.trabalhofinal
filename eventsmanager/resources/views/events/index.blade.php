            ...
            <tbody>
                @foreach ($data as $item)
                    <tr class="bg-light text-dark">
                        ...
                        <td>
                            @can('update', $item)
                                <a href= "{{route('events.edit', $item->id)}}" class="btn btn-success">
                            ...
                            @endcan
                            <a nohref style="cursor:pointer" onclick="showInfoModal('{{ $item }}', '{{ json_encode(['id', 'name']) }}')" class="btn btn-primary">
                        ...
                        <form action="{{ route('events.destroy', $item->id) }}" method="POST" id="form_{{$item->id}}">
                            @csrf
                            @method('DELETE')
                        </form>
                    </tr>
