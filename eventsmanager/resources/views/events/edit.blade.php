@extends('templates/main', ['titulo'=>"Alterar Evento"])
...
<form action="{{ route('events.update', $data->id) }}" method="POST">
        ...
        <div class="col" >
            ...
            <div class="form-floating mb-3">
                <input 
                    ...
                    placeholder="Nome"
                />
                <label for="eventdate">Nome do Evento</label>
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('events.index')}}" class="btn btn-secondary btn-block align-content-center">
